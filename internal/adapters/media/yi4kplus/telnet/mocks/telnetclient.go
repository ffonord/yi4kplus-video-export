...
// Source: internal/adapters/media/yi4kplus/telnet/telnetclient.go
//
// Generated by this command:
//
//	mockgen -package=mocks -source=internal/adapters/media/yi4kplus/telnet/telnetclient.go -destination=internal/adapters/media/yi4kplus/telnet/mocks/telnetclient.go
//
...
import (
	...
	telnet "github.com/ffonord/yi4kplus-video-export/internal/adapters/media/yi4kplus/telnet"
...
func (m *MockConnFactory) NewConn(host, port string) (telnet.Conn, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewConn", host, port)
	ret0, _ := ret[0].(telnet.Conn)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockReaderFactory) NewReader(arg0 telnet.Conn) telnet.Reader {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewReader", arg0)
	ret0, _ := ret[0].(telnet.Reader)
	return ret0
}
